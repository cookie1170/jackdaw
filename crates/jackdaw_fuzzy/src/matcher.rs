//! This module contains the actual matching engine with no ECS integration.
//!
//! The matching engine is [`FuzzyMatcher`], which takes a type parameter for the item,
//! which must implement the [`FuzzyItem`] trait.
//!
//! Example:
//!
//! ```
//! use jackdaw_fuzzy::matcher::{FuzzyMatcher, MatchedStr};
//!
//! let strings = vec![
